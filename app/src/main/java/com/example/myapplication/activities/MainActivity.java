...
public class MainActivity extends BaseActivity implements ConversionListener {
    private ActivityMainBinding binding; // bien databinding
    ...
    {
        binding.imageProfile.setOnClickListener(v -> changeProfile());
    ...
    private void signOut()
    {
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e-> showToast("unbale to sign out"));
    }
    @Override
